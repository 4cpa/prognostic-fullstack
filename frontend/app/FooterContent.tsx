...
export default function FooterContent() {
  ...
  return (
    <>
      ...
      >
        {/* TWINT Hexagon-T-Markenzeichen, isoliert aus offiziellem Logo */}
        <svg width="13" height="13" viewBox="13 9 35 42" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
          <defs>
            <radialGradient id="twint-a" cx="22.357%" cy="8.811%" gradientTransform="matrix(1 0 0 .91756 0 .007)" r="113.202%">
              <stop offset="0" stopColor="#fc0"/><stop offset=".4046" stopColor="#ff7000"/>
              <stop offset=".5503" stopColor="#ff1800"/><stop offset="1" stopColor="#f00"/>
            </radialGradient>
            <radialGradient id="twint-b" cx="2.552%" cy="14.432%" gradientTransform="matrix(1 0 0 .68117 0 .046)" r="139.457%">
              <stop offset="0" stopColor="#00b4e6"/><stop offset=".5737" stopColor="#0292cd"/>
